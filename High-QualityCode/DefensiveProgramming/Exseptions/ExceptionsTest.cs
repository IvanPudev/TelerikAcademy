...
namespace Exseptions
{
    public class ExceptionsTest
    {
        public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Count value: " + count + " is too big!");
            }
        ...
        public static string ExtractEnding(string str, int count)
        {
            if (count > str.Length)
            {
                throw new ArgumentOutOfRangeException("Count value: " + count + " is invalid!");
            }
        ...
        {
            var substr = Subsequence("Hi!".ToCharArray(), 2, 3);
