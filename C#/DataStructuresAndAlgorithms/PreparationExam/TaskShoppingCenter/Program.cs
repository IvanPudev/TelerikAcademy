...
namespace TaskShoppingCenter
{
    class Program
    {
        static readonly StringBuilder output = new StringBuilder();
        static readonly ShoppingCenter paradice = new ShoppingCenter();
    ...
    {
        static readonly MultiDictionary<string, Product> names = new MultiDictionary<string, Product>(true);
        static readonly MultiDictionary<string, Product> producers = new MultiDictionary<string, Product>(true);
        static readonly OrderedBag<Product> prices = new OrderedBag<Product>();
