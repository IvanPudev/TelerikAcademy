...
namespace _5.MaxSewuenceOfEncreasingElementsInArray
{
    class MaxSewuenceOfEncreasingElementsInArray
    {
        static void Main(string[] args)
        {
            Console.Write("Enter length of the arrey you want to check for encreasing subarrays: ");
